...
export default function InventoryPage() {
  ...
  return (
    <div style={{ height: 'calc(100vh - 52px)', display: 'flex', flexDirection: 'column', padding: "32px 40px 0 40px", width: '100%', maxWidth: 1600, margin: "0 auto", overflow: 'hidden' }}>
      ...
      {loading ? (
        ...
        <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', gap: 24, flex: 1, minHeight: 0, marginBottom: 40 }}>
          ...
          {/* List Overhaul */}
          <div className="card" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, borderRadius: 32, padding: 0 }}>
            <div className="flex bg-zinc-50 dark:bg-zinc-900/50 p-1 flex-shrink-0" style={{ borderRadius: '32px 32px 0 0' }}>
            ...
            <div className="flex-1 overflow-hidden flex flex-col" style={{ minHeight: 0, borderRadius: '0 0 32px 32px' }}>
